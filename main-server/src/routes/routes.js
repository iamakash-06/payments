...
//controllers
const { addVendor, addItems, allVendors, addBiller, adminLogin, adminAdd, vendorLogin, newOrder, getLiveOrders, getCompleteOrders, getItem, completeOrder, revertOrder , getUsername, vendorsDisplay, billerDisplay, editBiller, deleteBiller, addNewVendor, editVendor, deleteVendor, itemDisplay, addNewItems, editItem, deleteItem, orderDisplay} = require("../controllers/main.js");
...
router.post('/api/vendor/:vendorId/order', newOrder)
router.post('/api/vendor/:vendorId/food-items', addItems)
router.put('/api/vendor/:vendorId/order/:orderId/complete', completeOrder)
router.put('/api/vendor/:vendorId/order/:orderId/revert', revertOrder)
